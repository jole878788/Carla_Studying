...
'''
1-3是比较三种强化学习算法,状态信息使用waypoints(PPO, SAC, DDPG三种算法)
4-6是比较三种强化学习算法,状态信息使用angle_next_waypoint和maneuver(PPO, SAC, DDPG三种算法)
7-9都是SAC算法,引入数据增强,对比action_smoothing的影响
10-11是SAC算法,对比不同状态信息的影响
12-15是SAC算法,对比不同wrapper的影响
